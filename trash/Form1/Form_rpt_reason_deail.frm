...
Private Sub querys()
    ...
    a = a & " 'IDR' as ""Currency"",c.promisepay as ""Action Amount/PTP Amount"",date(NEXTACTDATE) as ""Next Action Date"",to_char(NEXTACTDATE,'hh:nn') as ""Next Action Time"",b.cmbbaseon as ""Reminder Mode"","
    ...
    a = a & " b.region as ""Kota"",a.statuscall as ""Group Call"",a.callwith as ""Call Destination"",recsource as ""Campaign Name"",b.Pay_Dt as ""LPD"" FROM ("
...
'''    End If
    ...
    If Combo1.text <> Empty Then
        If Len(mwhere) = 0 Then
            ...
            Else
                mwhere = mwhere + " where recsource ilike '%" + Combo1.text + "%'"
            End If
        Else
            If UCase(Combo1.text) = "RUPIAHPLUS" Then
                mwhere = mwhere + " and recsource ilike '%PLUS%'"
            Else
                mwhere = mwhere + " and recsource ilike '%" + Combo1.text + "%'"
            End If
        End If
    End If
