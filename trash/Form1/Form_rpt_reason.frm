...
Begin VB.Form Form_rpt_reason 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton SSCommand2 
         ...
         Height          =   375
         Left            =   9480
         Picture         =   "Form_rpt_reason.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   915
         Width           =   1605
      ...
      Begin VB.CommandButton cmdCari 
         Height          =   360
         Left            =   9480
         Picture         =   "Form_rpt_reason.frx":0646
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   480
         Width           =   1605
      ...
      Begin VB.CommandButton SSCommand1 
         ...
         Height          =   810
         Left            =   9480
         Picture         =   "Form_rpt_reason.frx":0C34
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   1350
         Width           =   1590
      ...
      Begin TDBDate6Ctl.TDBDate tgl_call 
         ...
         _ExtentX        =   2408
         _ExtentY        =   556
         Calendar        =   "Form_rpt_reason.frx":139A
         Caption         =   "Form_rpt_reason.frx":14B2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "Form_rpt_reason.frx":151E
         Keys            =   "Form_rpt_reason.frx":153C
         Spin            =   "Form_rpt_reason.frx":159A
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin TDBDate6Ctl.TDBDate tgl_call 
         ...
         _ExtentX        =   2302
         _ExtentY        =   556
         Calendar        =   "Form_rpt_reason.frx":15C2
         Caption         =   "Form_rpt_reason.frx":16DA
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "Form_rpt_reason.frx":1746
         Keys            =   "Form_rpt_reason.frx":1764
         Spin            =   "Form_rpt_reason.frx":17C2
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   30
      Picture         =   "Form_rpt_reason.frx":17EA
      Stretch         =   -1  'True
      Top             =   240
      Width           =   420
   End
   ...
   Begin VB.Image Image2 
      Height          =   825
      Left            =   -1980
      Picture         =   "Form_rpt_reason.frx":22F4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   17700
   End
End
Attribute VB_Name = "Form_rpt_reason"
...
'    strsql = strsql + " left join mgm_hst d on (a.custid=d.custid)"
     ...
     strsql = strsql + " FROM (select y.* from (SELECT id as last_id,date(tgl) as tgl_akhir,custid FROM mgm_hst group by 1,2,3) x,mgm_hst y where x.last_id=y.id) a "
     strsql = strsql + " LEFT JOIN mgm b ON (a.custid=b.custid) "
     strsql = strsql + " LEFT JOIN tblnegoptp c ON (a.custid=c.custid) "
    
    mwhere = " WHERE 1=1 and coalesce(a.lastcall,'')<>''"
