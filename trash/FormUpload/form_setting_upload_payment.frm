...
If bBool = False Then
    ...
    sStrsql = sStrsql + " SELECT column_name as nama_kolom From information_schema.Columns WHERE table_name='tbllunas' and table_schema='public'"
...
Dim RSTEMP As New ADODB.Recordset
    ...
    strsql = "insert into tbl_hst_setting_upload_payment (user_input,action_user) values ('" + MDIForm1.TxtUsername.Text + "','" + sAction + "') "
