...
Private Sub callrelease()
    ...
    While Not M_objrs.EOF
        ...
        ListItem.SubItems(3) = Format(IIf(IsNull(M_objrs("jam_awal")), "", M_objrs("jam_awal")), "yyyy-mm-dd")
        ListItem.SubItems(4) = Format(IIf(IsNull(M_objrs("jam_akhir")), "", M_objrs("jam_akhir")), "yyyy-mm-dd")
...
Private Sub getbankspv()
        ...
        Dim aa
        Dim zz As String
        'aa = Array("BCA", "BRI", "HCI", "MANDIRI", "MAYBANK", "PANIN", "PLUS", "UANG")
        aa = Array("BCA", "BRI", "HCI", "MANDIRI", "MAYBANK", "PANIN", "PLUS", "EXPRES", "GLOBAL", "COURT", "DANAMON")
        ...
        While Not M_objrs.EOF
                For i = 1 To 11
                    ...
                    If M_objrs!recsource Like "*" & a & "*" Then
                        ...
                        ElseIf aa(i - 1) = "UANG" Then
                            Combo1.AddItem "UANG EXPRESS"
                        Else
