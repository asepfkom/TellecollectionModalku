...
Begin VB.Form Form_rpt_activitycall 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton SSCommand2 
         ...
         Height          =   360
         Left            =   6525
         Picture         =   "Form_rpt_login_logout.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   2340
         Width           =   1620
      ...
      Begin VB.CommandButton SSCommand1 
         ...
         Height          =   1020
         Left            =   6525
         Picture         =   "Form_rpt_login_logout.frx":0646
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1245
         Width           =   1620
      ...
      Begin VB.CommandButton cmdCari 
         Height          =   375
         Left            =   6525
         Picture         =   "Form_rpt_login_logout.frx":0DAC
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   810
         Width           =   1605
      ...
      Begin TDBDate6Ctl.TDBDate tgl_call 
         ...
         _ExtentX        =   2408
         _ExtentY        =   556
         Calendar        =   "Form_rpt_login_logout.frx":139A
         Caption         =   "Form_rpt_login_logout.frx":14B2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "Form_rpt_login_logout.frx":151E
         Keys            =   "Form_rpt_login_logout.frx":153C
         Spin            =   "Form_rpt_login_logout.frx":159A
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin TDBDate6Ctl.TDBDate tgl_call 
         ...
         _ExtentX        =   2302
         _ExtentY        =   556
         Calendar        =   "Form_rpt_login_logout.frx":15C2
         Caption         =   "Form_rpt_login_logout.frx":16DA
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "Form_rpt_login_logout.frx":1746
         Keys            =   "Form_rpt_login_logout.frx":1764
         Spin            =   "Form_rpt_login_logout.frx":17C2
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "Form_rpt_activitycall"
...
Dim MOBJ As ADODB.Recordset
    ...
    strsql = "select username as ""Agent"", sum(waktu_logout- waktu_login) as ""Work Hours"",waktu_login as ""Waktu Login"",waktu_logout as ""Waktu Logout"" from usertbl_log where username in (" + ListCustId + ")"
    strsql = strsql + " and date(session_login) between '" + Format(tgl_call(0).Value, "yyyy-mm-dd") + "' and '" + Format(tgl_call(1).Value, "yyyy-mm-dd") + "' group by username,waktu_login,waktu_logout"
...
Private Sub export_data()
    ...
    strsql = "select username""Agent"", sum(waktu_logout- waktu_login) as ""Work Hours"",waktu_login as ""Waktu Login"",waktu_logout as ""Waktu Logout"" from usertbl_log where username in (" + ListCustId + ")"
    strsql = strsql + " and date(session_login) between '" + Format(tgl_call(0).Value, "yyyy-mm-dd") + "' and '" + Format(tgl_call(1).Value, "yyyy-mm-dd") + "' group by username,waktu_login,waktu_logout"
    isi_data (strsql)
