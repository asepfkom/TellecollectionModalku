...
Begin VB.MDIForm MDIForm1 
   BackColor       =   &H00FFFFFF&
   Caption         =   "MODALKU Collection  vr.19-06-2020-v1"
   ClientHeight    =   8910
   ClientLeft      =   8010
   ClientTop       =   1590
   ClientWidth     =   14385
   ...
   Begin VB.Timer Tmrreminder 
      ...
      Top             =   1440
   End
   Begin VB.Timer TimerAutoDial_REMINDER 
      Enabled         =   0   'False
      Interval        =   6000
      Left            =   1485
      Top             =   1440
   End
   Begin VB.Timer TimerAutoDial 
      Enabled         =   0   'False
      Interval        =   1000
      Left            =   1035
      Top             =   1425
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VB.ComboBox Combo1 
               Height          =   315
               ItemData        =   "MDIForm1.frx":A666
               Left            =   120
               List            =   "MDIForm1.frx":A668
               TabIndex        =   81
               Top             =   1560
               Visible         =   0   'False
               Width           =   3015
            ...
            Begin TDBDate6Ctl.TDBDate TDBDate3 
               ...
               _ExtentX        =   2593
               _ExtentY        =   503
               Calendar        =   "MDIForm1.frx":A66A
               Caption         =   "MDIForm1.frx":A782
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Lucida Console"
                  Size            =   8.25
                  Charset         =   0
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               DropDown        =   "MDIForm1.frx":A7EE
               Keys            =   "MDIForm1.frx":A80C
               Spin            =   "MDIForm1.frx":A86A
               AlignHorizontal =   0
               AlignVertical   =   0
               Appearance      =   1
               BackColor       =   12648447
            ...
            Begin TDBDate6Ctl.TDBDate TDBDate4 
               ...
               _ExtentX        =   2593
               _ExtentY        =   503
               Calendar        =   "MDIForm1.frx":A892
               Caption         =   "MDIForm1.frx":A9AA
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Lucida Console"
                  Size            =   8.25
                  Charset         =   0
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               DropDown        =   "MDIForm1.frx":AA16
               Keys            =   "MDIForm1.frx":AA34
               Spin            =   "MDIForm1.frx":AA92
               AlignHorizontal =   0
               AlignVertical   =   0
               Appearance      =   1
               BackColor       =   12648447
   ...
   Begin Threed.SSPanel SSPanel3 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TDBDate6Ctl.TDBDate TDBDate1 
            ...
            _ExtentX        =   2170
            _ExtentY        =   556
            Calendar        =   "MDIForm1.frx":D75B
            Caption         =   "MDIForm1.frx":D873
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Calibri"
               Size            =   9.75
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "MDIForm1.frx":D8DF
            Keys            =   "MDIForm1.frx":D8FD
            Spin            =   "MDIForm1.frx":D95B
            AlignHorizontal =   0
            AlignVertical   =   2
            Appearance      =   0
      ...
      End
   End
   Begin Threed.SSPanel sspanelAutoDialler 
      Align           =   4  'Align Right
      Height          =   7860
      Left            =   14265
      TabIndex        =   86
   ...
   Begin VB.Menu mnbar 
      ...
      End
      Begin VB.Menu mnrhd 
         Caption         =   "Report Breaktime Detail"
      End
      Begin VB.Menu mnrh 
...
Public tmrcount             As Double
Public tmrcount_recall      As Double
Dim satu As String
Dim dua As String
Dim tiga As String
Dim empat As String
...
Private Sub Command8_Click()
    Set M_objrs = New ADODB.Recordset
    M_objrs.CursorLocation = adUseClient
    CMDSQL = "select * from (select custid, count(custid) as hit from mgm_hst group by 1) a where hit > 6 order by 1 desc limit 10"
    M_objrs.Open CMDSQL, M_OBJCONN, adOpenDynamic, adLockOptimistic, adCmdText
    
    If M_objrs.RecordCount > 0 Then
        Set rs = New ADODB.Recordset
        rs.CursorLocation = adUseClient
        CMDSQL = "select * from mgm_hst where custid = '" & M_objrs!CustId & "' order by id desc"
        rs.Open CMDSQL, M_OBJCONN, adOpenDynamic, adLockOptimistic, adCmdText
    
        For i = 1 To 6
            If i = 1 Then
                M_OBJCONN.Execute "insert into test6 values ('" & rs!ID & "','" & rs!CustId & "','" & rs!TGL & "','" & rs!hst & "');"
            ElseIf i = 2 Then
                M_OBJCONN.Execute "update test6 set tgl2 = '" & rs!TGL & "', hst2 = '" & rs!hst & "' where custid = '" & rs!CustId & "';"
            ElseIf i = 3 Then
                M_OBJCONN.Execute "update test6 set tgl3 = '" & rs!TGL & "', hst3 = '" & rs!hst & "' where custid = '" & rs!CustId & "';"
            ElseIf i = 4 Then
                M_OBJCONN.Execute "update test6 set tgl4 = '" & rs!TGL & "', hst4 = '" & rs!hst & "' where custid = '" & rs!CustId & "';"
            ElseIf i = 5 Then
                M_OBJCONN.Execute "update test6 set tgl5 = '" & rs!TGL & "', hst5 = '" & rs!hst & "' where custid = '" & rs!CustId & "';"
            ElseIf i = 6 Then
                M_OBJCONN.Execute "update test6 set tgl6 = '" & rs!TGL & "', hst6 = '" & rs!hst & "' where custid = '" & rs!CustId & "';"
            End If
            rs.MoveNext
        Next i
    End If
...
Private Sub mnADS_Click()
    Form_AutoDialer.Show
    Form_AutoDialer.ZOrder vbBringToFront
End Sub
...
Private Sub mnhu_Click()
    Form_rpt_upload.Show
End Sub
...
Private Sub mnMP_Click()
    Form_master_privilage.Show 1
End Sub
...
Private Sub mnra_Click()
    'Form_rptcall_activity.Show
    Form_rptcallactivity.Show
End Sub

Private Sub mnrab_Click()
    Form_rpt_login_logout.Show
End Sub
...
Private Sub mnras_Click()
   Form_rptabsensi_summary.Show
End Sub
...
Private Sub mnrh_Click()
    Form_rpt_activity2.Show
End Sub

Private Sub mnrhd_Click()
    Form_rpt_history.Show
End Sub
...
Private Sub mnSA_Click()
    Form_pindah_agent.Show 1
End Sub
...
If UCase(MDIForm1.txtlevel.text) = "ADMIN" Or UCase(MDIForm1.txtlevel.text) = "ADMINISTRATOR" Or UCase(MDIForm1.txtlevel.text) = "SUPERVISOR" Then
...
Private Sub MnFile_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 7
            ...
            M_OBJCONN.Execute " update usertbl_log set waktu_logout = now() , durasi = now() - waktu_login where session_login= '" + Session_login + "' and username='" + MDIForm1.TxtUsername.text + "' and waktu_logout is null"

            'update session manual dialer
            If Session_ManualDial <> "" Then
            M_OBJCONN.Execute " update tbl_autodialer_agent_break set waktu_end =now(), durasi = now() - waktu_start where sessionid= '" + Session_ManualDial + "' and agent='" + MDIForm1.TxtUsername.text + "'"
            End If
            'update session autodialer
            If Session_AutoDial <> "" Then
            M_OBJCONN.Execute " update tbl_autodialer_agent_break set waktu_end = '" & waktu_server_sekarang & "', durasi = '" & waktu_server_sekarang & "' - '" + Session_AutoDial + "' where sessionid= '" + Session_AutoDial + "' and agent='" + abc + "'"
            End If
            'update session break
            If Session_Break <> "" Then
            M_OBJCONN.Execute " update tbl_autodialer_agent_break set waktu_end = now(), durasi = now() - waktu_start where sessionid= '" + Session_Break + "' and agent='" + MDIForm1.TxtUsername.text + "'"
            End If
            '===end asep====='
...
Private Sub dashboard()
    ...
    LVAgent.ColumnHeaders.ADD 3, , "Call", 10 * 120
    LVAgent.ColumnHeaders.ADD 4, , "Durasi", 10 * 120
...
'    q = q & " where tgl between '" & Format(TDBDate3.Value, "yyyy-mm-dd") & " 00:00:00' and '" & Format(TDBDate4.Value, "yyyy-mm-dd") & " 23:59:59' "
    ...
    '=========asep19/01/2020======'
    q = " select b.jml as ""New Data"", c.callattempt as ""Call"" ,c.durasi as ""Durasi"",d.statuscti as ""AgentStatus"""
    q = q + " ,a.* from("
...
'    End If
    ...
    q = q + " (select agent,statuscti  from mgm_hst where coalesce(statuscti,'')<>'' group by agent,statuscti) d on a.agent=d.agent"
    '=======end======'
    Set M_objrs = New ADODB.Recordset
...
Private Sub Timer1_Timer()
    ...
    M_objrs.Open cmdsql3, M_OBJCONN, adOpenDynamic, adLockOptimistic
...
Private Sub TimerAutoDial_Timer()

If F_AutoDial = True Then
'    TimerAutoDial.Enabled = False
       If MDIForm1.lstautodial.ListItems.Count <> 0 Then
            F_AutoDial = False
            TimerAutoDial.Enabled = False
            TimerAutoDial_REMINDER.Enabled = True
            F_AutoDial_POPUP = True
       Else
   ' If Form_customer.Tag = 0 Then
       If F_OPENCUST = False Then
            Call createschdule_1
            F_OPENCUST = True
            If awal = True Then
            WaitSecs (0.2)
            End If
            If VIEW_MGMDATA.lstautodial.ListItems.Count <> 0 Then
        ...
        Else
            ...
            MsgBox "Data Bucket Autodialer Telah Habis", vbOKOnly + vbInformation, "Informasi"
...
Private Sub disabled()
    If UCase(TxtUsername.text) <> "ADMIN" Then
        ...
        STRSQL = "select * from tbl_privilage where users = '" & txtlevel.text & "' order by id"
        Set rs = New ADODB.Recordset
        rs.CursorLocation = adUseClient
        ...
        If rs.RecordCount > 0 Then
            For i = 0 To 20
                Call menus(rs!Menu, rs!STATUS)
                    If i >= 18 Then
                        If i = 18 Then
                            SSCommand1(0).Enabled = rs!STATUS
                        ElseIf i = 19 Then
                            SSCommand1(10).Enabled = rs!STATUS
                        ElseIf i = 20 Then
                            SSCommand1(8).Enabled = rs!STATUS
                        End If
                    End If
                rs.MoveNext
            Next i
...
Private Sub menus(a As String, B As Integer)
    Dim Ctl As Control
    For Each Ctl In MDIForm1
        If B = 1 Then
            If Ctl.Name = a Then
                Ctl.Enabled = True
            End If
    ...
    Next
End Sub
Public Sub cek_data_Autodialer()
Dim M_objrs As New ADODB.Recordset
Dim M_OBJRS1 As New ADODB.Recordset
Dim strIDHEADER As String
Dim jmldata As Integer
Dim STRSQL As String
Dim StrSisa  As Integer
Dim strRetryCall_ongoing As Integer
Dim cekstatus As String
' JIka Retry call lebih dari 1x berdasarkan status UTC

' cek data di autodilaer jika data kurang dari 5 per agent yg dimaksud
Set M_objrs = New ADODB.Recordset
M_objrs.CursorLocation = adUseClient
STRSQL = "select id_header, count(distinct id_cust) as jml from tbl_autodialer where agent ='" + TxtUsername.text + "'group by id_header  order by id_header desc limit 1"
...
'  M_objrs1.Open "select * from tbl_autodialer_header where id_header='" + strIDHEADER + "' and agent = '" + TxtUsername.text + "'", M_OBJCONN, adOpenDynamic, adLockOptimistic
'  While Not M_objrs1.EOF
'    cekstatus = IIf(IsNull(M_objrs1!retrycall), "0", M_objrs1!retrycall)
'    M_objrs1.MoveNext
'  Wend
      
  
If jmldata <= 1 Then
       ' cek retrycall di tblheader
       Set M_objrs = New ADODB.Recordset
       M_objrs.CursorLocation = adUseClient
       STRSQL = "select *,retrycall - retrycall_ongoing as sisa from tbl_autodialer_header where id_header='" + strIDHEADER + "'"
       M_objrs.Open STRSQL, M_OBJCONN, adOpenDynamic, adLockOptimistic
       StrSisa = IIf(IsNull(M_objrs!sisa), "0", M_objrs!sisa)
       If StrSisa > 0 Then
            '======================================='
            'remark asep 20200611'
            'STRSQL = "insert into tbl_autodialer(id_header,autodialer_name,id_cust,agent,phone, tgl_start,tgl_end)"
            'STRSQL = STRSQL + " select id_header,autodialer_name,id_cust,agent,phone, now(),now() + '4 Hours'  "
            'STRSQL = STRSQL + " from tbl_autodialer_log where id_header='" + strIDHEader + "' and agent='" + MDIForm1.txtusername.text + "' and statuscall in ('UTC1','UTC2')"
            
            '----- 2020-06-11 budi cek autodialer utc1 utc2 retry call --
            STRSQL = "insert into tbl_autodialer(id_header,autodialer_name,id_cust,agent,phone, tgl_start,tgl_end)"
            STRSQL = STRSQL + " select id_header,autodialer_name, id_cust, agent, phone,now(),now() + '4 Hours' from("
            STRSQL = STRSQL + " select id_header,autodialer_name, id_cust, agent, phone,now(),now() + '4 Hours', id_autodialer_log,statuscall from"
            STRSQL = STRSQL + " tbl_autodialer_log where id_autodialer_log in(select max from("
            STRSQL = STRSQL + " select id_cust, max(id_autodialer_log) from"
            STRSQL = STRSQL + " tbl_autodialer_log where id_header='" + strIDHEADER + "' and agent='" + MDIForm1.TxtUsername.text + "' "
            STRSQL = STRSQL + " group by id_cust"
            STRSQL = STRSQL + " )a)"
            STRSQL = STRSQL + " )zz where zz.statuscall in('UTC1','UTC2');"
            M_OBJCONN.Execute STRSQL
    
            STRSQL = "update tbl_autodialer_header set retrycall_ongoing = retrycall_ongoing + 1  where id_header='" + strIDHEADER + "' and agent='" + MDIForm1.TxtUsername.text + "'"
            M_OBJCONN.Execute STRSQL
         Else
       End If
...
'====asep26042020===='
Public Sub createschdule()
On Error GoTo test
Dim ConReminnd As New ADODB.Connection
Dim cmdsql3 As String
Dim ddate As String
Dim JAM As String
Dim TGL As String
...
Dim M_OBJRSnew1 As New ADODB.Recordset
Dim CMDSQL As String
Set ConReminnd = New ADODB.Connection
'ConReminnd.Open CMDSQL
   Set ConReminnd = New ADODB.Connection
    ConReminnd.Open CMDSQLOPEN
    Set M_OBJRSnew = New ADODB.Recordset
    M_OBJRSnew.CursorLocation = adUseClient
    
    cmdsql3 = "select id_autodialer,id_cust,phone from tbl_autodialer where tgl_end >= now() and AGENT='" + MDIForm1.TxtUsername.text + "' limit 1"
    M_OBJRSnew.Open cmdsql3, ConReminnd, adOpenDynamic, adLockOptimistic, adCmdText
    no = 0
    VIEW_MGMDATA.lstautodial.ListItems.clear
    While Not M_OBJRSnew.EOF
        If VIEW_MGMDATA.lstautodial.ListItems.Count <> 0 Then
        Else
            VIEW_MGMDATA.lstautodial.ListItems.clear
        End If
        Set list = VIEW_MGMDATA.lstautodial.ListItems.ADD(, , no)
        list.SubItems(1) = IIf(IsNull(M_OBJRSnew!id_autodialer), "", M_OBJRSnew!id_autodialer)
        list.SubItems(2) = IIf(IsNull(M_OBJRSnew!id_cust), "", M_OBJRSnew!id_cust)
        list.SubItems(3) = IIf(IsNull(M_OBJRSnew!phone), "", M_OBJRSnew!phone)
        TimerAutoDial.Enabled = True
        F_AutoDial = True
        M_OBJRSnew.MoveNext
    Wend
    If M_OBJRSnew.RecordCount <> 0 Then
        msg "Auto dial akan dimulai sekarang"
        VIEW_MGMDATA.LstVwSearchMgm.Enabled = False
    ...
    Set ConReminnd = Nothing
Exit Sub
test:
MsgBox "Error Di timer Scheduling", vbInformation + vbOKOnly, App.Title
End Sub
Public Sub createschdule_1()
'On Error GoTo test
Dim ConReminnd As New ADODB.Connection
Dim cmdsql3 As String
Dim ddate As String
...
Dim CMDSQL As String
Set ConReminnd = New ADODB.Connection
'ConReminnd.Open sConnstring
   Set ConReminnd = New ADODB.Connection
    ConReminnd.Open CMDSQLOPEN
    Set M_OBJRSnew = New ADODB.Recordset
    M_OBJRSnew.CursorLocation = adUseClient
    
    cmdsql3 = "select id_autodialer,id_cust,phone from tbl_autodialer where tgl_end >= now() and AGENT='" + MDIForm1.TxtUsername.text + "' order by tgl_end limit 1"
    M_OBJRSnew.Open cmdsql3, ConReminnd, adOpenDynamic, adLockOptimistic, adCmdText
    no = 0
    VIEW_MGMDATA.lstautodial.ListItems.clear
    While Not M_OBJRSnew.EOF
        ...
        M_OBJRSnew.MoveNext
    Wend
'        VIEW_MGMDATA.LVSearchMgm.Enabled = False
'        Tmrreminder.Enabled = False
'        WaitSecs 60
...
MsgBox "Error Di timer Scheduling", vbInformation + vbOKOnly, App.Title
End Sub
Public Sub msg(isi As String)
    MsgBox isi, vbInformation, "Informasi"
End Sub
'===============end asep==================='
Public Sub cek_data()
    '=====asep20200510==========='
    ...
    Dim m_cust1 As New ADODB.Recordset
        ...
        CMDSQL = "select f_cek_new from mgm where f_cek_new in ('UTC1','UTC2')"
        m_cust1.Open CMDSQL, M_OBJCONN, adOpenDynamic, adLockOptimistic
        recall = cnull(m_cust1("f_cek_new"))

    '------mencari spv-----'
        sql3a = "select spvcode,team from usertbl where userid='" + TxtUsername + "'"
        Set M_OBJRS1 = New ADODB.Recordset
        M_OBJRS1.CursorLocation = adUseClient
        M_OBJRS1.Open sql3a, M_OBJCONN, adOpenDynamic, adLockOptimistic
        spvc = IIf(IsNull(M_OBJRS1("spvcode")), "", M_OBJRS1("spvcode"))
        teams = IIf(IsNull(M_OBJRS1("team")), "", M_OBJRS1("team"))
        autodlnm = spvc + "_autodial_" + Format(FungsiWaktuServer, "DD-MM-YYYY HH:MM:SS")

    If recall <> "" Then
        sqll = "insert into tbl_autodialer_header (autodialer_name, executor, tgl_start, tgl_end, flag_running) "
        sqll = sqll + "values ('" & autodlnm & "', '" & teams & "' , now()::timestamp, now()::timestamp + interval '1 hours','RUN');"
        M_OBJCONN.Execute sqll

        '------mencari max------------
        sql2 = "select max(id_header) as mid from tbl_autodialer_header"
        Set M_OBJRS1 = New ADODB.Recordset
        M_OBJRS1.CursorLocation = adUseClient
        M_OBJRS1.Open sql2, M_OBJCONN, adOpenDynamic, adLockOptimistic
        mida = IIf(IsNull(M_OBJRS1("mid")), "", M_OBJRS1("mid"))

        sql3 = "insert into tbl_autodialer (id_header,autodialer_name,id_cust,phone,tgl_start,tgl_end, agent)  "
        sql3 = sql3 + " select id_header,autodialer_name,custid,mobileno,tgl_start,tgl_end,agent from ( "
        sql3 = sql3 + " select distinct'" & mida & "'::integer as id_header,'" + autodlnm + "' as autodialer_name, custid::integer,mobileno, "
        sql3 = sql3 + " now() as tgl_start, now() + interval '1 hours' as tgl_end ,agent,oustanding,delq_amt_by_x from mgm where"
        sql3 = sql3 + " date(tglsource) = date(now()) and agent in ('" + TxtUsername + "') and f_cek_new in ('UTC1','UTC2') order by delq_amt_by_x desc,oustanding desc )a"
        M_OBJCONN.Execute sql3
'    Else
'        ""
    End If
End Sub
