...
Set M_objrs = New ADODB.Recordset
    M_objrs.CursorLocation = adUseClient
      ...
      STRSQL = STRSQL + " where trim(mgm.custid)=tbl_upload_temp.custid  and  (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null"
      STRSQL = STRSQL + " or tbl_upload_temp.f_flag=0 )"
      STRSQL = STRSQL + " and date(mgm.opendate) = date(tbl_upload_temp.instalment_duedate::timestamp)"
...
'If Check1.Value = vbChecked Then
    ...
    STRSQL = "update mgm set agent=a.agent,amount_disbursed=a.amount_disbursed,tenor=a.tenor,discpersen=a.discpersen,oustanding=a.oustanding,admin_fee=a.admin_fee,instalment_duedate=a.instalment_duedate,"
    STRSQL = STRSQL + " tgllunas=a.tgllunas,payment_status=a.payment_status,delq_amt_by_x=a.delq_amt_by_x,curbal=a.curbal,out_principle=a.out_principle,installment=a.installment,"
    STRSQL = STRSQL + " late_fee=a.late_fee,principal=a.principal,paid_interest=a.paid_interest,add_latefee=a.add_latefee,recsource=a.recsource,mobilenoadd2=a.mobilenoadd2,officenoadd1=a.officenoadd1,addrpt=a.addrpt,name=a.name,addrnow=a.addrnow,mobileno=a.mobileno,region=a.region, tglsource=now() from"
...
'    STRSQL = STRSQL + " (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null or tbl_upload_temp.f_flag=0 )   and  (f_flag_donot is null or f_flag_donot=0)"
    ...
    '=====asep20200605=='
    STRSQL = "select " + strinsert + " from  tbl_upload_temp where custid not in"
    STRSQL = STRSQL + " ( "
    STRSQL = STRSQL + " select  tbl_upload_temp.custid from mgm,tbl_upload_temp"
    STRSQL = STRSQL + " where mgm.custid=tbl_upload_temp.custid and date(tbl_upload_temp.instalment_duedate) = date(mgm.instalment_duedate::timestamp)) and (CUSTID IS NOT NULL OR CUSTID <>'') AND "
    STRSQL = STRSQL + " (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null or tbl_upload_temp.f_flag=0 )   and  (f_flag_donot is null or f_flag_donot=0)"
    '==================='
...
'        STRSQL = STRSQL + " (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null or tbl_upload_temp.f_flag=0 )   and  (f_flag_donot is null or f_flag_donot=0) AND tbl_upload_temp.CUSTID IS NOT NULL"
        ...
        '======asep20200605==========='
        STRSQL = "insert into mgm (" + strinsert + ")"
        STRSQL = STRSQL + "  select " + strinsert + " from  tbl_upload_temp where custid not in"
        STRSQL = STRSQL + " ( "
        STRSQL = STRSQL + " select  tbl_upload_temp.custid from mgm,tbl_upload_temp"
        STRSQL = STRSQL + " where mgm.custid=tbl_upload_temp.custid and date(tbl_upload_temp.instalment_duedate) = date(mgm.instalment_duedate::timestamp)) and "
        STRSQL = STRSQL + " (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null or tbl_upload_temp.f_flag=0 )   and  (f_flag_donot is null or f_flag_donot=0) AND tbl_upload_temp.CUSTID IS NOT NULL"
        '=======================================
...
'            M_OBJCONN.Execute (STRSQL)
            ...
            '============================replace data=========================='
            STRSQL = "update Tbl_Upload_Temp set mobileno = '0' || mobileno where SUBSTRING(mobileno,1,1) = '8'"
            M_OBJCONN.Execute (STRSQL)
            
            'Mobile No Hapus +62
            STRSQL = "update  Tbl_Upload_Temp set mobileno = REPLACE(mobileno,'+62','0') where mobileno LIKE '+62%'"
            M_OBJCONN.Execute (STRSQL)
            ...
            STRSQL = "update  Tbl_Upload_Temp set mobileno = REPLACE(mobileno,' ','') where mobileno LIKE '% %'"
            M_OBJCONN.Execute (STRSQL)
            
            '====================='
             STRSQL = "update Tbl_Upload_Temp set officenoadd1 = '0' || officenoadd1 where SUBSTRING(officenoadd1,1,1) = '8'"
            M_OBJCONN.Execute (STRSQL)
            
            'officenoadd1 No Hapus +62
            STRSQL = "update  Tbl_Upload_Temp set officenoadd1 = REPLACE(officenoadd1,'+62','0') where officenoadd1 LIKE '+62%'"
            M_OBJCONN.Execute (STRSQL)
            
            STRSQL = "update  Tbl_Upload_Temp set officenoadd1 = REPLACE(officenoadd1,'62','0') where officenoadd1 LIKE '62%'"
            M_OBJCONN.Execute (STRSQL)
            
            ' officenoadd1 Hilangkan spasi
            STRSQL = "update  Tbl_Upload_Temp set officenoadd1 = REPLACE(officenoadd1,' ','') where officenoadd1 LIKE '% %'"
            M_OBJCONN.Execute (STRSQL)
            
            '====================='
             STRSQL = "update Tbl_Upload_Temp set homenoadd1 = '0' || homenoadd1 where SUBSTRING(homenoadd1,1,1) = '8'"
            M_OBJCONN.Execute (STRSQL)
            
            'homenoadd1 No Hapus +62
            STRSQL = "update  Tbl_Upload_Temp set homenoadd1 = REPLACE(homenoadd1,'+62','0') where homenoadd1 LIKE '+62%'"
            M_OBJCONN.Execute (STRSQL)
            
            STRSQL = "update  Tbl_Upload_Temp set homenoadd1 = REPLACE(homenoadd1,'62','0') where homenoadd1 LIKE '62%'"
            M_OBJCONN.Execute (STRSQL)
            
            ' homenoadd1 Hilangkan spasi
            STRSQL = "update  Tbl_Upload_Temp set homenoadd1 = REPLACE(homenoadd1,' ','') where homenoadd1 LIKE '% %'"
            M_OBJCONN.Execute (STRSQL)
            
            '====================='
            STRSQL = "update Tbl_Upload_Temp set mobilenoadd2 = '0' || mobilenoadd2 where SUBSTRING(mobilenoadd2,1,1) = '8'"
            M_OBJCONN.Execute (STRSQL)
            
            'Spouse_Phone_Number No Hapus +62
            STRSQL = "update  Tbl_Upload_Temp set mobilenoadd2 = REPLACE(mobilenoadd2,'+62','0') where mobilenoadd2 LIKE '+62%'"
            M_OBJCONN.Execute (STRSQL)
            
            STRSQL = "update  Tbl_Upload_Temp set mobilenoadd2 = REPLACE(mobilenoadd2,'62','0') where mobilenoadd2 LIKE '62%'"
            M_OBJCONN.Execute (STRSQL)
            
            ' Spouse_Phone_Number Hilangkan spasi
            STRSQL = "update  Tbl_Upload_Temp set mobilenoadd2 = REPLACE(mobilenoadd2,' ','') where mobilenoadd2 LIKE '% %'"
            M_OBJCONN.Execute (STRSQL)
            
'            ' MONTHLY_INTEREST_RATE ubah koma jadi titik
'            STRSQL = "update  Tbl_Upload_Temp set discpersen = REPLACE(discpersen,',','.') where mobilenoadd2 LIKE '% %'"
'            M_OBJCONN.Execute (STRSQL)
...
'      STRSQL = STRSQL + " or tbl_upload_temp.f_flag=0)"
'      STRSQL = STRSQL + " and (f_flag_donot is null or f_flag_donot=0) and date(mgm.instalment_duedate) = date(tbl_upload_temp.instalment_duedate::timestamp)"
      
      '====asep======='
      STRSQL = "SELECT mgm.custid,custid as unik from mgm where Exists"
      STRSQL = STRSQL + " (SELECT custid FROM tbl_upload_temp where tbl_upload_temp.custid=mgm.custid and date(tbl_upload_temp.instalment_duedate) = date(mgm.instalment_duedate::timestamp))"
      '================='
'STRSQL = "select * from mgm"
    ...
    'cek data new
      ...
      STRSQL = STRSQL + " ( "
      STRSQL = STRSQL + " select  tbl_upload_temp.""ID"" from mgm,tbl_upload_temp"
      STRSQL = STRSQL + " where mgm.custid=tbl_upload_temp.custid and date(mgm.instalment_duedate) = date(tbl_upload_temp.instalment_duedate::timestamp) ) and (CUSTID IS NOT NULL OR CUSTID<>'') AND   "
      STRSQL = STRSQL + " (tbl_upload_temp.f_flag=1 or tbl_upload_temp.f_flag is null or tbl_upload_temp.f_flag=0  )and (f_flag_donot is null or f_flag_donot=0) "
      'strsql = strsql + " AND (coalesce(homeno,'')<>''or coalesce(mobileno,'')<>'' or coalesce(officeno,'')<>'')"
...
'
'cn.Open "Provider = Microsoft.ACE.OLEDB.12.0;data source = " & CommonDialog1.FileName & ";Extended Properties=Excel 12.0;"
'
...
''    "FROM [MySheet$]"
'
''CMDSQLOPEN = "Driver={PostgreSQL ANSI}; Server=localhost; PORT=5432; Database=modalku2; UID=postgres; PWD=123"
'
'strsql = "SELECT * INTO [odbc;Driver={PostgreSQL ANSI};" & _
'    "Server=localhost;Database=modalku2;Port=5432;" & _
'    "UID=postgres;PWD=123].tbl_upload_temp " & _
'    "FROM [Sheet1$]"
'
''strsql = "SELECT * INTO [odbc;Driver= " + CMDSQLOPEN + "].tbl_upload_temp " & _
''    "FROM [Sheet1$]"
'Debug.Print strsql
